...
func (_q *UserQuery) QueryNote() *NoteQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, user.NoteTable, user.NoteColumn),
		)
...
func (_q *UserQuery) WithNote(opts ...func(*NoteQuery)) *UserQuery {
	query := (&NoteClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withNote; query != nil {
		if err := _q.loadNote(ctx, query, nodes,
			func(n *User) { n.Edges.Note = []*Note{} },
			func(n *User, e *Note) { n.Edges.Note = append(n.Edges.Note, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadNote(ctx context.Context, query *NoteQuery, nodes []*User, init func(*User), assign func(*User, *Note)) error {
	...
	query.Where(predicate.Note(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.NoteColumn), fks...))
	}))
